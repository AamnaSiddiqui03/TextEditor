    ...
    >
      <div className="container-fluid">
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          {/* <button className="btn btn-outline-primary mx-2" type="submit" onClick={DarkMode}>Dark Mode</button>
          <button className="btn btn-outline-light" type="submit">Light Mode</button> */}
          {/* </form> */}
        </div>
      </div>
    </nav>
